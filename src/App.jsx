...
const highlight = (text = "", query) => {
  ...
  return text.split(regex).map((part, i) =>
    part.toLowerCase() === query.trim().toLowerCase() ? (
      <span key={i} style={{ background: "#ff3b30", color: "#fff", padding: "2px 5px", borderRadius: "5px" }}>
        {part}
      </span>
    ) : part
  );
...
export default function App() {
  ...
  return (
    <div style={{
      minHeight: "100vh",
      background: "radial-gradient(circle at top, #351010 0%, #0b0b0b 38%, #050505 100%)",
      color: "#fff",
      ...
      >
        ...
        <section style={{ textAlign: "center", minHeight: "520px" }}>
          <p style={{
            display: "inline-block", border: "1px solid rgba(255,255,255,0.14)", borderRadius: "999px",
            padding: "7px 13px", color: "#ddd", fontSize: "0.85rem",
            background: "rgba(255,255,255,0.06)", backdropFilter: "blur(12px)",
          }}>
            Consumer safety intelligence for everyday products
          </p>
          <h1 style={{
            fontSize: "clamp(3.4rem, 9vw, 7rem)", lineHeight: 0.92,
            margin: "210px 0 0", letterSpacing: "-0.085em",
        ...
        {/* ── Search Panel ── */}
        <section style={{
          marginTop: "-70px", background: "rgba(17,17,17,0.84)",
          border: "1px solid rgba(255,255,255,0.08)", borderRadius: "28px",
          padding: "24px", boxShadow: "0 35px 100px rgba(0,0,0,0.5)", backdropFilter: "blur(14px)",
        }}>
            ...
            {["milk", "chicken", "Tylenol", "syringe", "toddler stool", "air fryer"].map((item) => (
              <button
                ...
                style={{
                  ...
                  color: "#bbb", borderRadius: "999px", padding: "5px 11px", cursor: "pointer",
                }}
              >
                {item}
              </button>
        ...
        {!loading && searched && results.length === 0 && (
          <section style={{
            marginTop: "30px", padding: "24px", borderRadius: "20px",
            ...
            return (
              ...
              >
                ...
                <div style={{ position: "relative" }}>
                  <div style={{
                    display: "inline-flex",
                    background: severity === "HIGH" ? "rgba(255,59,48,0.25)" : severity === "MEDIUM" ? "rgba(255,149,0,0.25)" : "rgba(255,255,255,0.1)",
                  ...
                  <div style={{
                    marginTop: "18px", padding: "18px", borderRadius: "18px",
                    background: "rgba(0,0,0,0.28)", border: "1px solid rgba(255,255,255,0.08)", textAlign: "left",
                  }}>
                      ...
                      {guidance.actions.map((action, index) => (
                        <motion.div
                          ...
                          style={{
                            ...
                            background: "rgba(255,255,255,0.045)", color: "#ddd",
                    ...
                    <button
                      ...
                      style={{
                        ...
                        color: "#ddd", cursor: "pointer", fontWeight: 800,
                      }}
                    >
                  ...
                  <div style={{ display: "flex", gap: "10px", flexWrap: "wrap", marginTop: "12px" }}>
                    <button
                      ...
                      style={{ padding: "13px 17px", borderRadius: "13px", background: "#ff3b30", border: "none", color: "#fff", fontWeight: 900, cursor: "pointer" }}
                    >
                    ...
                    <button
                      ...
                      style={{
                        padding: "13px 17px", borderRadius: "13px",
          ...
          >
            <motion.div
              ...
              style={{
                ...
                background: "linear-gradient(135deg, rgba(26,26,26,0.98), rgba(12,12,12,0.98))",
                border: "1px solid rgba(255,255,255,0.12)", borderRadius: "24px",
                padding: "28px", boxShadow: "0 40px 120px rgba(0,0,0,0.7)",
              }}
            >
              {!joined ? (
                <>
                  ...
                  <div style={{
                    background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.08)",
                    borderRadius: "16px", padding: "14px", color: "#fff", margin: "16px 0",
                  }}>
                  ...
                  <input
                    ...
                    type="email"
                    style={{
                      width: "100%", boxSizing: "border-box", padding: "15px", borderRadius: "14px",
                      border: "1px solid rgba(255,255,255,0.12)", background: "#070707",
                      color: "#fff", outline: "none", fontSize: "1rem",
                    }}
                  />
                  <button
